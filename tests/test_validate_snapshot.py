...
def test_from_dist_reads_the_real_committed_baseline() -> None:
    ...
    assert snapshot.required_field_coverage == dict.fromkeys(REQUIRED_ENTITY_FIELDS, 2188)
    ...
    assert snapshot.optional_field_coverage == {"wikiUrl": 2145, "blurb": 2031, "icon": 2096}
